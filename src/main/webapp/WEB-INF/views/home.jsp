					...
					<c:if test="${not empty repositories}">
					   <div class="searchResult">
					      <table class="searchTable">
							...
							<c:forEach var="repository" items="${repositories}" end="10">
						...
						<c:if test="${repositories.size()>10}">
							<div><a href="javascript:toggleExtra()" id="extralink">see more results...</a></div>
							<table id="extraresults" class="searchTable">
								<c:forEach var="repository" items="${repositories}" begin="11">
								<tr id="${repository.name}${repository.username}">
